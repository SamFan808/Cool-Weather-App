  ...
  if (cityText === "") {
    ...
    .then(function (response) {
      ...
      .then(function (data) { 
        ...
        cityBlock.appendChild(span).className = "date"
        ...
        var uvRequest = "https://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&appid=0d2d646f1fc53c15f97082e153457db8&"
        fetch(uvRequest)
        .then(function (response) {
          return response.json();
        })
        ...
        // 5-day fetch request ====================================
        var fiveRequest = "https://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&appid=0d2d646f1fc53c15f97082e153457db8&"
        fetch(fiveRequest)
        .then(function (response) {
          return response.json();
        })
